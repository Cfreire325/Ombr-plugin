...
export const TAILWIND_NEUTRALS = ["slate", "gray", "zinc", "neutral", "stone"] as const;

export type TailwindNeutral = (typeof TAILWIND_NEUTRALS)[number];
...
export const TAILWIND_PALETTES = Object.keys(TAILWIND_COLORS);

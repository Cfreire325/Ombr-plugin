...
- document historique / transitional
- utile comme reference de travail V2
- ne pas traiter comme la source de verite principale du repo

Note:

- les chemins `src/*` de ce document renvoient a l'ancienne structure racine
- pour l'implementation active actuelle, privilegier `packages/plugin-starter-tokens/*`
